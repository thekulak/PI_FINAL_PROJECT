			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>Alamat<span>Jl.Arujna</span></li>
					</ul>
					<ul>
					...
					<ul>
						...
						<li>Telp.<span>(+123) 233 2362 826</span></li>
					</ul>
				</div>
				<div class="col-md-8 agileinfo_mail_grid_right">
					<form action="#" method="post">
						<div class="col-md-6 wthree_contact_left_grid">
							<input type="text" name="Nama" value="Nama*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nama**';}" required="">
							<input type="email" name="Email" value="Email*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email*';}" required="">
						</div>
						<div class="col-md-6 wthree_contact_left_grid">
							<input type="text" name="Telephone" value="Telephone*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Telephone*';}" required="">
							<input type="text" name="Subjek" value="Subjek*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subjek**';}" required="">
						</div>
						<div class="clearfix"> </div>
