		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="about.html">Tentang</a><i>/</i></li>
		...
		<div class="services">
			...
			<div class="w3ls_service_grids">
				<div class="col-md-5 w3ls_service_grid_left">
					<h4>dapat hubungi</h4>
					<p>CS     : 123-456789</P>
					<P>Alamat : Jl.xxxxx xxx xxxxx</p>
					<p>Email  : The_Kulak@xxx.xxx 
				</div>
			...
			<div class="w3ls_service_grids1">
				...
				<div class="col-md-6 w3ls_service_grids1_right">
					<ul>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Kualitas barang terjamin</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Barang baru dan fresh</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Belanja mudah dan menyenangkan</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Kurir terpercaya</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Jaminan belanjaan sampai dengan aman dan sesuai</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Semua ada disini</li>
					</ul>
					<a href="Diskon.html">Belanja Sekarang</a>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
	...
	<div class="newsletter-top-serv-btm">
		<div class="container">
			<div class="col-md-4 wthree_news_top_serv_btm_grid">
				...
				<h3>Keranjang</h3>
				<p>Menampung daftar belanjaan mu.</p>
			</div>
			<div class="col-md-4 wthree_news_top_serv_btm_grid">
				<div class="wthree_news_top_serv_btm_grid_icon">
				...
				<p>peforma pada saat menggunakan layanan The Kulak.</p>
			</div>
			<div class="col-md-4 wthree_news_top_serv_btm_grid">
				<div class="wthree_news_top_serv_btm_grid_icon">
				...
				<p>gratis pengiriman barang dengan ketentuan.</p>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
